...
public static class UiRenderer
{
    ...
    <style>
    :root{color-scheme:light dark;--bg:#f4f5f8;--panel:#fff;--text:#1c2030;--muted:#646b7c;--accent:#7656d6;--line:#d9dce5;--error:#b42318}@media(prefers-color-scheme:dark){:root{--bg:#11131a;--panel:#1b1e28;--text:#f2f3f7;--muted:#aeb4c4;--line:#343949;--error:#ff8a80}}html[data-theme=light]{color-scheme:light;--bg:#f4f5f8;--panel:#fff;--text:#1c2030;--muted:#646b7c;--line:#d9dce5;--error:#b42318}html[data-theme=dark]{color-scheme:dark;--bg:#11131a;--panel:#1b1e28;--text:#f2f3f7;--muted:#aeb4c4;--line:#343949;--error:#ff8a80}*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--text);font:15px/1.5 system-ui,sans-serif}nav{background:#171927;padding:13px 22px;display:flex;gap:20px;flex-wrap:wrap}nav strong{color:white;margin-right:12px}nav a{color:#d9d3ff;text-decoration:none}main{max-width:1200px;margin:28px auto;padding:0 20px}section,.table-wrap,table{background:var(--panel)}section{border:1px solid var(--line);border-radius:10px;padding:18px;margin:18px 0}.cards,.editor-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:15px;margin-bottom:24px}table{width:100%;border-collapse:collapse}th,td{padding:11px;text-align:left;border-bottom:1px solid var(--line);vertical-align:top}.table-wrap{overflow:auto;border:1px solid var(--line);border-radius:10px}code{word-break:break-all}form{display:flex;gap:16px;align-items:center;flex-wrap:wrap}form.inline{display:inline}form.stack{display:flex;flex-direction:column;align-items:stretch}input,button,select,.button{padding:7px 10px}.button{display:inline-block;border:1px solid var(--line);border-radius:3px;color:var(--text);text-decoration:none;background:var(--panel)}button.danger{color:var(--error)}.error{color:var(--error);font-weight:600}.state{font-weight:600}.badge{font-size:12px;background:var(--accent);color:white;border-radius:10px;padding:2px 7px}p,.small{color:var(--muted)}.small{font-size:13px}.waveform-preview{margin:18px 0 0}.waveform-preview img{display:block;max-width:100%;height:auto;border:1px solid var(--line);border-radius:6px;background:repeating-conic-gradient(#222 0 25%,#292929 0 50%) 0/16px 16px}.waveform-preview figcaption{margin-top:7px;color:var(--muted);font-size:13px}
