...
public static class UiRenderer
{
    ...
    public static string Diagnostics(HealthContract health, string theme) =>
        Page("Diagnostics", theme, $"<h1>Diagnostics</h1><p>Host version: <strong>{E(health.HostVersion)}</strong></p><p>Health: <strong>{E(health.HostStatus)}</strong></p><p><a href=/health>Machine-readable health API</a></p><p>Detailed diagnostics and export arrive in M6.</p>");
